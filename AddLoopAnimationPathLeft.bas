Attribute VB_Name = "AddLoopAnimationPathLeft"
'添加水平向左循环动画
Sub AddLoopAnimationPathLeft()
    ...
    Const mMotionEffectDuration As Single = 8 'alter this to suit
    Const mSlideShowShapeCount = 3 '界面完整显示Shape的个数，Shape总数需 >= mSlideShowShapeCount + 2
    ...
    For i = 1 To mShapeCount Step 1
        ...
        With mEffect
            ...
            .Timing.RepeatCount = 100 '-2147483648 没有找到设置‘直到下一次单击’或‘直到幻灯片末尾’的设置方法
            .Timing.TriggerType = msoAnimTriggerWithPrevious
            .Timing.TriggerDelayTime = (i - 1) * (mMotionEffectDuration / mDelayFactor)
            
            
            '添加msoAnimTypeMotion水平向左循环动画
            .Behaviors.Add(msoAnimTypeMotion).MotionEffect.Path = "M 0.3333 0 L -1 0 E"
